...
export default function DashboardScreen({ navigation }) {
  ...
  // Calculation: 100 credits = 10 INR, so 1 credit = 0.1 INR
...
const styles = StyleSheet.create({
  ...
  notifBtn: { width: 44, height: 44, borderRadius: 22, backgroundColor: 'rgba(255,255,255,0.2)', justifyContent: 'center', alignItems: 'center', position: 'relative' },
  notifIcon: { fontSize: 22 },
  notifBadge: { position: 'absolute', top: 2, right: 2, backgroundColor: Colors.danger, borderRadius: 8, minWidth: 16, height: 16, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 3 },
  notifBadgeText: { color: Colors.white, fontSize: 9, fontWeight: '800' },
  balanceCard: { backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: Radius.lg, padding: Spacing.lg, alignItems: 'center', marginBottom: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.25)' },
  ...
  actionCard: { width: '30%', aspectRatio: 1, borderRadius: Radius.lg, justifyContent: 'center', alignItems: 'center', ...Shadow.sm, minWidth: 90 },
  actionIcon: { fontSize: 28, marginBottom: 6 },
  actionLabel: { fontSize: FontSize.xs, fontWeight: '800', textAlign: 'center' },
  statsCards: { flexDirection: 'row', gap: 10 },
  miniCard: { flex: 1, borderRadius: Radius.lg, padding: 14, alignItems: 'center', ...Shadow.sm },
  ...
  referralCard: { backgroundColor: Colors.primaryLight, borderWidth: 1, borderColor: Colors.primary + '40', borderRadius: Radius.lg, padding: Spacing.md },
